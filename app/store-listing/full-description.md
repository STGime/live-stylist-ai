...
- **Live camera analysis in every session (Premium, after the free trial).** Same live camera analysis, available repeatedly.
- **Style preview image generation (Premium).** Generate quick preview images of suggested looks — fringe, frames, bold lip — alongside the conversation.
